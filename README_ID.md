...
**Sembilan plugin penagihan DeepSeek yang sudah dipublikasikan, dijalankan terhadap tabel ini: tiga lolos semuanya.** Tanpa dependensi, Node 16+; fungsi penentu jam sibuk tiap proyek disalin ke `conformance/adapters.mjs` dan dipatok ke satu commit.
