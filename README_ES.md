...
**Nueve plugins de facturación de DeepSeek publicados, pasados por esta tabla: tres la superan entera.** Sin dependencias, Node 16+; la función de cada proyecto está transcrita en `conformance/adapters.mjs` y fijada a un commit.
